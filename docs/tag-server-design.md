...
| 段階    | 構成                                           | 説明                                                                                                                                                                                                                                                                                                                                                                                 |
| ------- | ---------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| 現状    | banto-hub と relay-wright が直接 PLC 接続      | この2つだけ（ChronoGazer はまだデータ源そのものが無い — #383 で SLMP / Modbus TCP / Hub 経由の3ドライバを実装する）。単独稼働なら問題なし。同居時はセッション数に注意（W5 実機検証は relay-wright の凍結で保留）                                                                                                                                                                     |
