...
作成日: 2026-08-04
状態: **実装追従中（2026-08-08 更新）**。起案時は設計先行だったが、
apps/banto-hub として実装が進行中 — T0〜T4 / T6〜T12 実装済み・残 T5
（配布・運用強化）。実装状況は §9（T系）の表を正とする。マイルストーンは
§9、オーナー判断待ちの未決事項は §10、UX 改善（T9〜T13）は
