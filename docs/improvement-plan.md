...
作成日: 2026-08-08
状態: **進行中(Phase 1 マージ済み = PR #58、Phase 2 進行中)**。
H1〜H4・H6・H8 完了。H5 は vitest 導入 + CI test 実効化まで完了
(E2E 拡充は Phase 4)。H10 は推奨案採用が決定(2026-08-08)、read
スコープ細分化のみ実装時に案を提示してから着手。
