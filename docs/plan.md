...
- banto / banto-industrial は**自社著作物**として保持し、案件アプリには
  依存ライブラリとして**利用許諾**で提供する
...
| I3b | 収集エンジン（banto-collect。PLC 定期読み出し→I3a 書き込み） | I1, I2, I3a | 下記 §5 参照 |
| I4 | 時系列クエリ層（期間クエリ + サーバ側間引き） | I3a, I3b | banto M13 チャートへ直結。ハイブリッド合成の土台 |
