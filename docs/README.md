...
最終更新: 2026-09-21（#383 段階2b / R1-C: chronogazer に収集ランタイムの
...
| [r1-plan.md](r1-plan.md)                                     | 記録計 R1 実施計画。**運用中**（R1-A 完了、R1-B は #383 段階2a で着手・レジストリ CRUD 実装済み、R1-C は C-1/C-2/C-3a/C-3b 実装済み・C-4 残り、R1-D 未着手）。 |
