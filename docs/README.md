...
- **banto-tagclient**: **S1b完了（2026-08-31）**。読み取り専用DTO、Endpoint/Secret境界、stable ID resolver、
  REST catalog/values transportを実装済み。WebSocket/worker・再接続はS2/S3で未実装。Hubのrelease tagは未確定。
