...
- **banto-tagclient**: **S3b-1完了、S3b-2未完了（2026-08-31）**。読み取り専用DTO、Endpoint/Secret境界、
  ...
  公開Handle、worker所有権、明示shutdown、catalog起点の再接続・backoff・停止割り込みを実装済み。rebinding、config_changed再解決、retry拡張はS3b-2で未実装。
  Hubのrelease tagは未確定。
